"""Estudar o codigo e comentar aquilo que entendeu
"""
...
# input perguntando em qual level você gostaria de jogar
...
# Variaveis
count = 0  # conta a pontuacao
lost = False  # verifica se perdeu
...
class Bola:
    ...
    def __init__(self, canvas, Barra, color):
        ...
        starts_x = [-3, -2, -1, 1, 2, 3]  # lista com os pontos de start
